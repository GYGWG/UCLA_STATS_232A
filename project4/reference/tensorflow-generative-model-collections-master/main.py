...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='mnist', choices=['MNIST-data', 'fashion-mnist', 'celebA'],
...
def main():
    ...
    # open session
    models = [GAN] #, CGAN, infoGAN, ACGAN, EBGAN, WGAN, WGAN_GP, DRAGAN, LSGAN, BEGAN, VAE, CVAE]
